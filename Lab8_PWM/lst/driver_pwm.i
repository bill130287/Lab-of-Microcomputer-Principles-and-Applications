...
#line 5 "Driver_PWM.c"
#line 1 ".\\CM0\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 1 ".\\CM0\\CoreSupport\\core_cm0.h"
...
#line 56 ".\\CM0\\CoreSupport\\core_cm0.h"
...
#line 82 ".\\CM0\\CoreSupport\\core_cm0.h"
...
#line 377 ".\\CM0\\CoreSupport\\core_cm0.h"
...
#line 395 ".\\CM0\\CoreSupport\\core_cm0.h"
...
#line 500 ".\\CM0\\CoreSupport\\core_cm0.h"
...
#line 770 ".\\CM0\\CoreSupport\\core_cm0.h"
...
#line 75 ".\\CM0\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
#line 1 ".\\CM0\\DeviceSupport\\Nuvoton\\NUC1xx\\system_NUC1xx.h"
...
#line 76 ".\\CM0\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 77 ".\\CM0\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 6629 ".\\CM0\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 6685 ".\\CM0\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 6703 ".\\CM0\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 6756 ".\\CM0\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 6782 ".\\CM0\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"

#line 6789 ".\\CM0\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
...
#line 6835 ".\\CM0\\DeviceSupport\\Nuvoton\\NUC1xx\\NUC1xx.h"
	...
	switch (PWM_no) {
		...
		case 4 : ((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPBMFP.TM3_PWM4=1;      
             ...
             ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.PWM45_EN =1;  
						 *((unsigned int *)(((( uint32_t)0x50000000) + 0x00000)+0x50))|=0x10; 
...
void PWM_Freq(uint8_t PWM_no, uint32_t PWM_freq, uint8_t PWM_duty)
{
	...
	switch(PWM_no) {
		case 0 : if (PWM_freq==0) ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->POE.PWM0=0;
	           else             ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->POE.PWM0=1;
		         break;
		case 1 : if (PWM_freq==0) ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->POE.PWM1=0;
	           else             ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->POE.PWM1=1;
		         break;		
		case 2 : if (PWM_freq==0) ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->POE.PWM2=0;
	           else             ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->POE.PWM2=1;
		         break;
		case 3 : if (PWM_freq==0) ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->POE.PWM3=0;
	           else             ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->POE.PWM3=1;
		         break;		
		case 4 : if (PWM_freq==0) ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM0=0;
	           else             ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM0=1;
		         break;
		case 5 : if (PWM_freq==0) ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM1=0;
	           else             ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM1=1;
		         break;		
		case 6 : if (PWM_freq==0) ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM2=0;
	           else             ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM2=1;
		         break;
		case 7 : if (PWM_freq==0) ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM3=0;
	           else             ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM3=1;
		         break;		
		default: ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->POE.PWM0=0;
		         ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->POE.PWM1=0;
						 ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->POE.PWM2=0;
						 ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->POE.PWM3=0;
		         ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM0=0;
						 ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM1=0;
						 ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM2=0;
						 ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->POE.PWM3=0;
						 break;
		}
	  ...
	  CMR = (CNR +1) * PWM_duty /100  - 1;
		...
		switch(PWM_no) {
			case 0 : ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CSR.CSR0 = 0;             
	             ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PPR.CP01 = PWM_PreScaler; 
			         ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR0 = CNR;     	 			   
	             ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR0 = CMR;				       
			         break;
			case 1 : ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CSR.CSR1 = 0;             
	             ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PPR.CP01 = PWM_PreScaler; 
			         ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR1 = CNR;     	 			   
	             ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR1 = CMR;				       
			         break;
			case 2 : ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CSR.CSR2 = 0;             
	             ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PPR.CP23 = PWM_PreScaler; 
			         ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR2 = CNR;     	 			   
	             ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR2 = CMR;				       
			         break;
			case 3 : ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CSR.CSR3 = 0;             
	             ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->PPR.CP23 = PWM_PreScaler; 
			         ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CNR3 = CNR;     	 			   
	             ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000))->CMR3 = CMR;				       
			         break;
			case 4 : ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CSR.CSR0 = 0;             
	             ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->PPR.CP01 = PWM_PreScaler; 
			         ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = CNR;     	 			   
	             ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = CMR;				       
			         break;
			case 5 : ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CSR.CSR1 = 0;             
	             ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->PPR.CP01 = PWM_PreScaler; 
			         ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR1 = CNR;     	 			   
	             ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR1 = CMR;				       
			         break;
			case 6 : ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CSR.CSR2 = 0;             
	             ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->PPR.CP23 = PWM_PreScaler; 
			         ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR2 = CNR;     	 			   
	             ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR2 = CMR;				       
			         break;
			case 7 : ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CSR.CSR3 = 0;             
	             ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->PPR.CP23 = PWM_PreScaler; 
			         ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR3 = CNR;     	 			   
	             ((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR3 = CMR;				       
			         break;			
			default: break;
	}
}
