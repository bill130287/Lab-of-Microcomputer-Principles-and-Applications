...
#line 10 "Smpl_PWM_Music.c"
#line 1 "note_freq.h"
#line 143 "note_freq.h"

#line 11 "Smpl_PWM_Music.c"
...
void SYS_Delay(unsigned int us)
{
	  ...
	  repeat = 25;
			((SysTick_Type *) ((0xE000E000) + 0x0010))->CTRL &= ~( 1 | 1 << 16 ); 
			((SysTick_Type *) ((0xE000E000) + 0x0010))->LOAD = us;
			((SysTick_Type *) ((0xE000E000) + 0x0010))->VAL  = 0;
...
void PWM4_Init(void)
{
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->PPR.CP01 = 49; 
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CSR.CSR0 = 0x4; 
	
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->PCR.CH0MOD = 1; 
	
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = 0;
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = 0;
...
void PWM_Freq(unsigned int freq, unsigned char duty_ratio)
{
	...
	if(freq==0){
		...
		N = (1000000/freq) - 1;
		M = (duty_ratio)*(N+1)/100-1;
	}

	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CMR0 = M;
	((PWM_T *) ((( uint32_t)0x40100000) + 0x40000))->CNR0 = N;
}
...
int main (void)
{
  ...
  uint8_t i, duty_cycle;
	...
	uint16_t music[72] = {
		...
		988 ,1047 ,1175 ,1319 ,1319 , 0 ,784 ,1397 ,1319 ,1175 ,1175 , 0 ,
		698 ,1319 ,1175 ,1047 ,1047 , 0 ,659 ,1175 ,1047 ,988 ,988 , 0 };
	
	uint32_t pitch[72] = {
		125000, 125000, 125000, 125000,	125000, 125000, 125000, 125000,	125000, 125000, 125000, 125000,
		125000, 125000, 125000, 125000,	125000, 125000, 125000, 125000,	125000, 125000, 125000, 125000,
		125000, 125000, 125000, 125000,	125000, 125000, 125000, 125000,	125000, 125000, 125000, 125000,
	...
	*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x59;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x16;*((volatile uint32_t *)(((( uint32_t)0x50000000) + 0x00000) + 0x100)) = 0x88;
	...
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0.STCLK_S = 0x3; 
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->ALTMFP.PB11_PWM4 = 1; 
	((GCR_T *) ((( uint32_t)0x50000000) + 0x00000))->GPBMFP.TM3_PWM4 = 1;  
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL2.PWM45_S = 0x2; 
	((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK.PWM45_EN = 0x1; 
