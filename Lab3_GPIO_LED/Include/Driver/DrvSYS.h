...
#define DRVSYS_MINOR_NUM 02
#define DRVSYS_BUILD_NUM 3

#define DRVSYS_VERSION_NUM      _SYSINFRA_VERSION(DRVSYS_MAJOR_NUM,DRVSYS_MINOR_NUM,DRVSYS_BUILD_NUM)  

//E_DRVSYS_ERR_UNLOCK_FAIL      Unlock protected register failed
//E_DRVSYS_ERR_LOCK_FAIL        Lock protected register failed
...
#define E_DRVSYS_ERR_REG_PROTECTED  _SYSINFRA_ERRCODE(TRUE, MODULE_ID_DRVSYS, 7)
